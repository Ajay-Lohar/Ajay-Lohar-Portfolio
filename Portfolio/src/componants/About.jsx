  ...
  return (
    ...
    <div className='w-full mt-5 flex  justify-center'>
      <div className='w-250  flex'>
        ...
        <div className='px-24'>
          <h1 className='text-2xl  my-5'>Languages</h1>
        ...
        <div className='px-24'>
          <h1 className='text-2xl  my-5'>Nationality</h1>
          <hr className='w-30 border-[4px] border-[#a578a5] my-4 hover:border-[purple] duration-300' />
          <ul className=''>
            <li>Indian</li>
        ...
        <div className='px-24'>
          <h1 className='text-2xl  my-5'>Hobbies</h1>
          <hr className='w-30 border-[4px] border-[#a578a5] my-4 hover:border-[purple] duration-300' />
          <ul className=''>
